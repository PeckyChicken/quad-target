...
Each day brings 3 new puzzles. An easy one with no multiplication, a hard one with multiplication required, and a harder one with 3-digit numbers instead of 2-digit numbers.
